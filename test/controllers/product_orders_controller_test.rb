...
class ProductOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_order" do
    assert_difference('ProductOrder.count') do
      post product_orders_url, params: { product_order: { order: @product_order.order, product: @product_order.product } }
    end
  ...
  test "should update product_order" do
    patch product_order_url(@product_order), params: { product_order: { order: @product_order.order, product: @product_order.product } }
